...
class WulpusUSSConfigGen:
    ...
    def convert_to_registers(self):
        ...
        self.sampling_freq_reg = int(
            cfg.USS_CAPT_OVER_SAMPLE_RATES_REG[
                cfg.USS_CAPTURE_ACQ_RATES.index(self.sampling_freq)
            ]
        ...
        self.start_hvmuxrx_reg = int(
            self.start_hvmuxrx * cfg.us_to_ticks["start_hvmuxrx"]
        )
        ...
        self.start_pgainbias_reg = int(
            self.start_pgainbias * cfg.us_to_ticks["start_pgainbias"]
        )
        self.start_adcsampl_reg = int(
            self.start_adcsampl * cfg.us_to_ticks["start_adcsampl"]
        )
